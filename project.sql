...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 13 2023 г., 09:10
...
INSERT INTO `Records` (`id`, `title`, `patient`, `doctor`, `diagnosis`) VALUES
(5, 'test', 1, 1, 1);
...
--
ALTER TABLE `Records`
  ADD CONSTRAINT `records_ibfk_1` FOREIGN KEY (`patient`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `records_ibfk_2` FOREIGN KEY (`doctor`) REFERENCES `Doctors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `records_ibfk_3` FOREIGN KEY (`diagnosis`) REFERENCES `Diagnoses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
